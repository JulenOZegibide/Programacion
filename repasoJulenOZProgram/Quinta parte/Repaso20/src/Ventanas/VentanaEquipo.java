...
public class VentanaEquipo extends javax.swing.JFrame {
    ...
    public VentanaEquipo(String nombre, String puesto) {
        initComponents();
        this.setLocationRelativeTo(null);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(modificar==true)
            Repaso20.modificarequipo2(tfnombre.getText(),tfpuesto.getText());
        else
        Repaso20.añadirEquipo(tfnombre.getText(),tfpuesto.getText());
